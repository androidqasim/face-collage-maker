 ...
 */
public class SketchFilter extends ImageFilterGroup {
    ...
    private TextureSamplingFilter mTextureSamplingFilter;

    public SketchFilter() {
        super();
        mTextureSamplingFilter = new TextureSamplingFilter(SKETCH_FRAGMENT_SHADER);
        addFilter(new GrayscaleFilter());
        addFilter(mTextureSamplingFilter);
    }

    public void setLineSize(final float size) {
        mTextureSamplingFilter.setLineSize(size);
    }
}
