...
public class ImageFilter {
	...
	public ImageFilter(final String vertexShader, final String fragmentShader) {
	...
	protected void setFloatVec4Array(final int location,
			final float[] arrayValue) {
		if(arrayValue == null){
			return;
		}
		...
		runOnDraw(new Runnable() {
			@Override
			public void run() {
				GLES20.glUniform4fv(location, arrayValue.length / 4,
